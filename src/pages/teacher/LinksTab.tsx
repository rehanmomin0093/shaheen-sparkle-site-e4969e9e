...
import { Plus, Trash2, ExternalLink, Loader2, Link as LinkIcon } from "lucide-react";
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold">
          Important Links — {assignment.class_name}{assignment.section ? `-${assignment.section}` : ""}
        </h2>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 pt-2">
              ...
              <Button className="w-full" disabled={!title.trim() || !url.trim() || addLink.isPending} onClick={() => addLink.mutate()}>
